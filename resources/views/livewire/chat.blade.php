<section class="w-[100%] h-[calc(100vh-80px)] flex mt-[80px]">
    <div class="w-[30%] h-[100%]   {{$darkmode ? 'bg-dark' : 'bg-[#fafafa]'}} ">
        <div class="myContainer">
            <div class="flex justify-center items-center gap-[20px] p-[20px] rounded-[10px]">
                <div class=" border border-1 border-black  p-[10px] text-black cursor-pointer rounded-[10px] {{$darkmode ? 'border-white' : 'border-dark'}}">
                    <i class="fa-solid fa-sliders {{$darkmode ? 'text-white' : 'text-dark'}}""></i>
                    <span class="{{$darkmode ? 'text-white' : 'text-dark'}}">Filter</span>
                </div>
                <div class=" border border-1 border-black p-[10px] text-black cursor-pointer rounded-[10px] {{$darkmode ? 'border-white' : 'border-dark'}}">
                    <i class="fa-regular fa-message {{$darkmode ? 'text-white' : 'text-dark'}}"></i>
                    <span class="{{$darkmode ? 'text-white' : 'text-dark'}}">New Message</span>
                </div>

            </div>
            <div class="w-[100%]">
                <input type="search" placeholder="Search" class="w-[100%] rounded-[10px] {{$darkmode ? 'bg-grey' : 'bg-white'}}">
            </div>
        </div>
        <div class="overflow-y-scroll  h-[calc(100vh-208px)]">
            <div class="users myContainer  mt-[50px] flex  justify-center items-start flex-col gap-[10px] ">
                <div class="w-[100%] flex justify-between items-center hover:bg-[#d6d6d6e7] p-[10px] rounded-[10px]">
    ...
    <div class=" {{$darkmode ? 'bg-dark' : 'bg-white'}}  w-[50%] h-[100%] relative  border-[#00000042] border-x-[1px]">
        <div
        ...
        <div
            ...
            <input type="text" placeholder="message" class="w-[100%] rounded-[10px] {{$darkmode ? 'bg-grey' : 'bg-white'}}">
            <i class="fa-solid fa-microphone cursor-pointer text-[20px]"></i>
            <i class="fa-solid fa-paper-plane cursor-pointer text-[20px]"></i>
        </div>
    </div>
    <div class="w-[20%] h-[100%] {{$darkmode ? 'bg-dark' : 'bg-white'}} ">
        <div class="myContainer h-[100%] flex justify-center items-center flex-col">
            ...
            <div class="w-[100%] flex flex-col gap-[10px]">
                ...
                <div class=" cursor-pointer p-[10px] flex justify-center items-center gap-[10px]">
                    <h1 class="bg-[red] text-[white] border py-[5px] px-[15px] border-1 border-[red] rounded-[10px]">
                        Block</h1>
